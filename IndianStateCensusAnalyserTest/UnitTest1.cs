...
namespace IndianStateCensusAnalyserTest
{
    public class Tests
    {
         ...
         static string indianStateCensusFilePath = @"C:\Users\Radha\source\repos\IndianCensus\IndianCensus\CSVFiles\IndiaStateCensusData.csv";
       //  static string indianStateCodeFilePath = @"\Radha\source\repos\IndianCensus\IndianCensus\CSVFiles\IndiaStateCode.csv";
         static string wrongHeaderIndianCensusFile = @"C:\Users\Radha\source\repos\IndianCensus\IndianCensus\CSVFiles\WrongIndiaStateCensusData.csv";
       //  static string wrongIndianStateCodeFilePath = @"C:\Users\Radha\source\repos\IndianCensus\IndianCensus\CSVFiles\WrongIndiaStateCode.csv";
         static string IndianStateCodeFiletype = @"C:\Users\Radha\source\repos\IndianCensus\IndianCensus\CSVFiles\IndiaStateCode.txt";
       //  static string delimeterIndianStateCodeFilePath = @"C:\Users\Radha\source\repos\IndianCensus\IndianCensus\CSVFiles\DelimiterIndiaStateCode.csv";
         static string delimeterIndianCensusCodeFilePath = @"C:\Users\Radha\source\repos\IndianCensus\IndianCensus\CSVFiles\DelimiterIndiaStateCensusData.csv";
